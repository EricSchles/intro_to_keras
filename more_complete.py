...
# create model
model = Sequential()
model.add(Dense(100, input_shape=(90,), activation='relu', name="dense_1"))
model.add(Dense(25, input_shape=(100,), activation="relu", name="dense_2"))
model.add(Dense(44, input_shape=(25,), activation="sigmoid", name="dense_4"))
model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
model.fit(zone_beat, event_clearance_group, epochs=1, verbose=1)
